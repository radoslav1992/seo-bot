...
> **Направи НОВ проект, не ползвай стар.** Настройките за съгласие — име,
> обхвати, публикуване, проверка — са на ниво **проект** и се споделят от
> всички OAuth клиенти в него. Тоест в чужд проект клиентите ти ще виждат
> името на онова приложение на екрана за одобрение, а ако то иска чувствителен
> обхват, наследяваш и неговия таван от 100 потребителя, макар на теб да ти
> трябва само Search Console. Проектите са безплатни.
