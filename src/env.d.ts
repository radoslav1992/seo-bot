...
interface Env {
  ...
  /**
   * Показва текста на неочакваните грешки в отговора (`1` или `true`).
   *
   * За диагностика от браузър, когато дневникът не е под ръка. Държи се
   * изключен: съобщенията на D1 и на fetch носят имена на таблици и адреси.
   */
  DEBUG_ERRORS?: string;
